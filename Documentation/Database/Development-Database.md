...
| ----------------- | ----------------- | ------------------- | ------------------------------------------------------------- |
| QQProjectName     | QQProjectName     | DefinitelyDurable1! | Used for the main .NET backend while running the application. |
| QQProjectNameTest | QQProjectNameTest | TotallyTrusted2!    | Used by the test project when running integration tests.      |
