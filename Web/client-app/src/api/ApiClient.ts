...
export interface IApiClient {
     ...
     * @return Success
     */
    getSecretMessage(password: string | null): Promise<GetSecretMessageResponse>;
}
...
export class ApiClient implements IApiClient {
    ...
    protected processGetWeather(response: Response): Promise<GetWeatherResponse> {
        ...
        if (status === 200) {
            ...
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as GetWeatherResponse;
            return result200;
            });
        } else if (status === 500) {
            return response.text().then((_responseText) => {
            let result500: any = null;
            result500 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as ApiErrorResponse;
     ...
     * @return Success
     */
    getSecretMessage(password: string | null, signal?: AbortSignal): Promise<GetSecretMessageResponse> {
    ...
    protected processGetSecretMessage(response: Response): Promise<GetSecretMessageResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as GetSecretMessageResponse;
            return result200;
            });
        } else if (status === 500) {
            return response.text().then((_responseText) => {
